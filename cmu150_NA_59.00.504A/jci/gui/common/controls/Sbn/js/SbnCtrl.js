...
SbnCtrl.prototype._createStructure = function()
{
    ...
    switch(this.properties.sbnStyle)
    {
        ...
        case "Style07":
            // -- Audio Level --
            // imagePath1
            this.imagePath1.className = "SbnCtrl_Style07_Image1";
            // text1
            this.text1.className = "SbnCtrl_Style07_Text4";
         default:
            break;
    }
 ...
 */
SbnCtrl.prototype._setInnerTextOrHTML = function(elt, txt)
{
    if (elt)
    {
        if (txt)
...
SbnCtrl.prototype._setText1 = function()
{
    ...
    else if(this.properties.sbnStyle == "Style07")
    {
        var stationRelay = "";
        if (this.properties.text1Id)
        {
        ...
        if(this.properties.text4Id)
        {
            this.properties.text4 = framework.localize.getLocStr(this.uiaId, this.properties.text4Id, this.properties.text4SubMap);
        }
        if(this.properties.text5Id)
        {
            this.properties.text5 = framework.localize.getLocStr(this.uiaId, this.properties.text5Id, this.properties.text5SubMap);
        }
        if(this.properties.text4 && this.properties.text5)
        {
            stationRelay = this.properties.text4+' ('+this.properties.text5+')';
        }
        else if(this.properties.text4 && ((this.properties.text5=="")||(this.properties.text5==null)))
        {
            stationRelay = this.properties.text4;
        }
        // if informations about AM/FM or frequency are unknown it will show blank
        if (this.properties.text1 && this.properties.text2)
        {  
            var concatStr='<span class="SbnCtrl_Style07_Text1">' + this.properties.text1 + ' ' +  this.properties.text2 + ' </span>'+
                          ' '+'<span class="SbnCtrl_Style07_Text2">'+this.properties.text3 + ' </span>'+
                          ' '+'<span class="SbnCtrl_Style07_Text3">'+stationRelay+' </span>'; 
            this._setInnerTextOrHTML(this.text1, concatStr);
