...
{  
    ...
    this._adjustBtnFocused = false;         // (Boolean) true if the Adjust (or Close) button is focused.
    this._closeProperties = null;           // (Object) Adjust button properties when tabs are visible
    this._backButtonProperties = null;      // (Object) Back button properties for calibration screen.
    this._cvcButtonProperties = null;       // (Object) CVC button properties for TVM screen.
    ...
    this._backBtn = null;                   // (Object) back button for calibration screen      
    this._backBtnFocused = false;           // (Boolean) true if the back button is focused.

    this._cvcBtn = null;                   // (Object) CVC button for TVM screen      
    this._cvcBtnFocused = false;           // (Boolean) true if the cvc button is focused.	

    //@formatter:off
    this.properties = {
        "style": "top",                 // (String) Options "top", "bottom", "botton_RHD", "botton_LHD","none"
        "adjustButtonConfig" : null,    // (Object) passes properties to the adjust/close button
        "backButtonConfig" : null,      // (Object) passes properties to the back button for calibration screen
        "cvcButtonConfig" : null,      // (Object) passes properties to the CVC button for TVM screens to the Camera View
    ...
    if (this.properties.style === "bottom" || this.properties.style === "bottom_RHD" || this.properties.style === "bottom_LHD")
    {
...
{   
    ...
    this._adjustProperties = {
        ...
        "visible": this.properties.adjustButtonConfig.visible,
    ...
    //Top Style
    if (this.properties.style === "top")
    {
        this._adjustProperties.enabledClass = "ScreenSettings2CtrlAdjustBtn_En";
        this._adjustProperties.disabledClass = "ScreenSettings2CtrlAdjustBtn_Ds";
        this._adjustProperties.focusedClass = "ScreenSettings2CtrlAdjustBtn_Focused";
        this._adjustProperties.downClass = "ScreenSettings2CtrlAdjustBtn_Down";
        this._closeProperties.enabledClass = "ScreenSettings2CtrlCloseBtn_En";
        this._closeProperties.focusedClass = "ScreenSettings2CtrlCloseBtn_Focused";
        this._closeProperties.downClass = "ScreenSettings2CtrlCloseBtn_Down";
    }
    ...
    //RHD bottom
    if (this.properties.style === "bottom_RHD")
    {
        this._adjustProperties.enabledClass = "ScreenSettings2Ctrl_Bottom_RHD_AdjustBtn_En";
        this._adjustProperties.disabledClass = "ScreenSettings2Ctrl_Bottom_RHD_AdjustBtn_Ds";
        this._adjustProperties.focusedClass = "ScreenSettings2Ctrl_Bottom_RHD_AdjustBtn_Focused";
        this._adjustProperties.downClass = "ScreenSettings2Ctrl_Bottom_RHD_AdjustBtn_Down";
        this._closeProperties.enabledClass = "ScreenSettings2Ctrl_Bottom_RHD_CloseBtn_En";
        this._closeProperties.focusedClass = "ScreenSettings2Ctrl_Bottom_RHD_CloseBtn_Focused";
        this._closeProperties.downClass = "ScreenSettings2Ctrl_Bottom_RHD_CloseBtn_Down";
		
	//CVC Button
	if (this.properties && this.properties.cvcButtonConfig)
        {
	    // Set up the CVC button.
	    this._cvcButtonProperties = {
		"enabled": this.properties.cvcButtonConfig.enabled,
		"enabledClass" : "ScreenSettings2CtrlRHDCVCBtn_En",
		"disabledClass" : "ScreenSettings2CtrlRHDCVCBtn_Ds",
		"focusedClass" : "ScreenSettings2CtrlRHDCVCBtn_Focused",
		"downClass" : "ScreenSettings2CtrlRHDCVCBtn_Down",
		"appData" : this.properties.cvcButtonConfig.appData,
		"selectCallback" : this._cvcBtnSelectHandler.bind(this),
	    };
	    this._cvcBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._cvcButtonProperties);
        }  
    }
	
    //LHD bottom
    if (this.properties.style === "bottom_LHD")
    {
        this._adjustProperties.enabledClass = "ScreenSettings2Ctrl_Bottom_LHD_AdjustBtn_En";
        this._adjustProperties.disabledClass = "ScreenSettings2Ctrl_Bottom_LHD_AdjustBtn_Ds";
        this._adjustProperties.focusedClass = "ScreenSettings2Ctrl_Bottom_LHD_AdjustBtn_Focused";
        this._adjustProperties.downClass = "ScreenSettings2Ctrl_Bottom_LHD_AdjustBtn_Down";
		
	// For close buttons, all the properties and position will be same as Bottom close button.
        this._closeProperties.enabledClass = "ScreenSettings2Ctrl_Bottom_CloseBtn_En";
        this._closeProperties.focusedClass = "ScreenSettings2Ctrl_Bottom_CloseBtn_Focused";
        this._closeProperties.downClass = "ScreenSettings2Ctrl_Bottom_CloseBtn_Down";
	...
	if (this.properties && this.properties.cvcButtonConfig)
		...
		this._cvcButtonProperties = {
			"enabled": this.properties.cvcButtonConfig.enabled,
		        "enabledClass" : "ScreenSettings2CtrlLHDCVCBtn_En",
			"disabledClass" : "ScreenSettings2CtrlLHDCVCBtn_Ds",
			"focusedClass" : "ScreenSettings2CtrlLHDCVCBtn_Focused",
			"downClass" : "ScreenSettings2CtrlLHDCVCBtn_Down",
			"appData" : this.properties.cvcButtonConfig.appData,
			"selectCallback" : this._cvcBtnSelectHandler.bind(this),
		};
		this._cvcBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._cvcButtonProperties);
    ...
    if (this.properties && this.properties.backButtonConfig)
    {
        // Set up the back button.
        this._backButtonProperties = {
            "enabled": this.properties.backButtonConfig.enabled,
            "enabledClass" : "ScreenSettings2CtrlBackBtn_En",
            "disabledClass" : "ScreenSettings2CtrlBackBtn_Ds",
            "focusedClass" : "ScreenSettings2CtrlBackBtn_Focused",
            "downClass" : "ScreenSettings2CtrlBackBtn_Down",
            "appData" : this.properties.backButtonConfig.appData,
            "selectCallback" : this._backBtnSelectHandler.bind(this),
        };
        this._backBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._backButtonProperties);
    }
    ...
    if (this.properties.style === "bottom_RHD")
    {
        this._tabsCont.style.left = "0px";
        this._closeBg.style.left = "724px";
    }
    ...
    if (this.properties && this.properties.backButtonConfig)
    {
        this._instantiateBackBtn();
    }
	
    // instantiate CVC button
	if (this.properties && this.properties.cvcButtonConfig)
    {
        this._instantiateCVCBtn();
    }
...
ScreenSettings2Ctrl.prototype._setDefaultFocus = function()
{
    ...
    if (!this._tabsVisible)
    {
        ...
        if (this.properties.secondaryButtonConfig != null)
        {
         ...
         else if (this.properties && this.properties.cvcButtonConfig && this.properties.cvcButtonConfig.enabled == true)
        {
            this._adjustBtnFocused = false;
            this._cvcBtn.handleControllerEvent("controllerActive");
            this._cvcBtn.handleControllerEvent("acceptFocusFromLeft");
            this._cvcBtnFocused = true;
        }
	...
	else if (this.properties && this.properties.backButtonConfig && this.properties.backButtonConfig.enabled == true)
        {
            this._adjustBtnFocused = false;
            //this._adjustBtn.handleControllerEvent("lostFocus");
            this._backBtn.handleControllerEvent("controllerActive");
            this._backBtn.handleControllerEvent("acceptFocusFromLeft");
            this._backBtnFocused = true;
        }
        else
        {
            //Do nothing
...
ScreenSettings2Ctrl.prototype._adjustSelectHandler = function(e)
{
    ...
    if (this._cvcBtnFocused)
    {
        this._cvcBtnFocused = false;
        this._cvcBtn.handleControllerEvent("lostFocus");
        this._cvcBtn.handleControllerEvent("controllerActive");
        this._adjustBtn.handleControllerEvent("acceptFocusFromLeft");
        //this._adjustBtnFocused = true;
    }
     else if (this._backBtnFocused)
    {
        this._backBtnFocused = false;
        this._backBtn.handleControllerEvent("lostFocus");
        this._backBtn.handleControllerEvent("controllerActive");
 ...
 */
ScreenSettings2Ctrl.prototype._backBtnSelectHandler = function(btnRef, appData, params)
{
    ...
    if (this.properties && this.properties.backButtonConfig && typeof this.properties.backButtonConfig.selectCallback == 'function')
    {
        var params = {
        "backBtn": "backBtn"
    };
        this.properties.backButtonConfig.selectCallback(this, appData, params);
    }
};

/*
 * Handler for when the CVC button is clicked.
 */
ScreenSettings2Ctrl.prototype._cvcBtnSelectHandler = function(btnRef, appData, params)
{
    if (this._adjustBtnFocused)
    {
        this._adjustBtnFocused = false;
        this._adjustBtn.handleControllerEvent("lostFocus");
        this._cvcBtn.handleControllerEvent("controllerActive");
        this._cvcBtn.handleControllerEvent("acceptFocusFromRight");
        this._cvcBtnFocused = true;
    }
    if (this.properties && this.properties.cvcButtonConfig && typeof this.properties.cvcButtonConfig.selectCallback == 'function')
    {
        var params = {
        "cvcBtn": "cvcBtn"
    };
    this.properties.cvcButtonConfig.selectCallback(this, appData, params);
    }
};
/*
...
ScreenSettings2Ctrl.prototype._instantiateAdjustBtn = function()
{
    ...
    log.info( "visible=" +  this._adjustProperties.visible);

    if(this._adjustProperties.visible != null && this._adjustProperties.visible != undefined  && this._adjustProperties.visible === false)
    {
         this._adjustBtn.divElt.style.display = "none";
    }
}
/*
 * Instantiates Back Button
 */
ScreenSettings2Ctrl.prototype._instantiateBackBtn = function()
{
    if (this._tabsVisible == true)
    {
        this._backBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._closeProperties);
    }
    else
    {
        this._backBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._backButtonProperties);
    ...
    if (this.properties && this.properties.backButtonConfig && this.properties.backButtonConfig.enabled == null)
    {
        this.properties.backButtonConfig.enabled = false;
    }
    
    if(this.properties && this.properties.backButtonConfig)
    {
        this._backBtn.setEnabled(this.properties.backButtonConfig.enabled);
    }
}

/*
 * Instantiates CVC Button
 */
ScreenSettings2Ctrl.prototype._instantiateCVCBtn = function()
{
    if (this._tabsVisible == true)
    {
        this._cvcBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._closeProperties);
    }
    else
    {
        this._cvcBtn = framework.instantiateControl(this.uiaId, this.divElt, "ButtonCtrl", this._cvcButtonProperties);
    ...
    if (this.properties && this.properties.cvcButtonConfig && this.properties.cvcButtonConfig.enabled == null)
    {
        this.properties.cvcButtonConfig.enabled = false;
    }
    
    if(this.properties && this.properties.cvcButtonConfig)
    {
        this._cvcBtn.setEnabled(this.properties.cvcButtonConfig.enabled);
    }
}
/*
...
ScreenSettings2Ctrl.prototype.setAtSpeed = function(atSpeed)
{
	...
	if(this.properties.adjustButtonConfig.enabled === true)
        {
            this._adjustBtn.setEnabled(isEnabled);
        }

        //just disable/enable the backbtn
        if(this.properties && this.properties.backButtonConfig && this.properties.backButtonConfig.enabled === true)
        {
            this._backBtn.setEnabled(isEnabled);
        }
    }
}
    ...
    else
    {
        switch(eventId)
        {
            ...
            case "ccw":
                ...
                if (this.properties && this.properties.cvcButtonConfig)
                {
                    if (this.properties.adjustButtonConfig.enabled)
                    {
                        ...
                        {
                            if (this.properties.cvcButtonConfig && this.properties.cvcButtonConfig.enabled === true)
                            {
                                this._adjustBtnFocused = false;
                                this._adjustBtn.handleControllerEvent("lostFocus");
                                this._cvcBtn.handleControllerEvent("controllerActive");
            ...
            case "selectStart":
                ...
                else if (this.properties && this.properties.backButtonConfig)
                {
                    // select either the adjust button, or the back button
                    if (this._adjustBtnFocused)
                    {
                        this._adjustBtn.handleControllerEvent(eventId);
                    }
                    ...
                    {
                        this._backBtn.handleControllerEvent(eventId);
                    }
                }
		else if (this.properties && this.properties.cvcButtonConfig)
                {
                    // select either the adjust button, or the CVC button
                    if (this._adjustBtnFocused)
                    {
                        this._adjustBtn.handleControllerEvent(eventId);
                    }
                    ...
                    {
                        this._cvcBtn.handleControllerEvent(eventId);
                    }
                }
                else
                {
            ...
            case "right":
                ...
                else if (this.properties && this.properties.backButtonConfig)
                {
                    if (this.properties.adjustButtonConfig.enabled)
                    {
                        ...
                        {
                            if (this.properties.backButtonConfig && this.properties.backButtonConfig.enabled === true)
                            {
                                this._adjustBtnFocused = false;
                                this._adjustBtn.handleControllerEvent("lostFocus");
                                this._backBtn.handleControllerEvent("controllerActive");
...
ScreenSettings2Ctrl.prototype.getContextCapture = function()
{
    ...
    return {
        ...
        backFocusState: this._backBtnFocused,
...
ScreenSettings2Ctrl.prototype.restoreContext = function(focusState)
{
    ...
    this._backBtnFocused = focusState.backFocusState;
