...
Dialog3Ctrl.prototype._createStructure = function()
{
    ...
    // indentation following createElement() is intentional for readability
    ...
    if (this.properties.contentStyle == "style18" || this.properties.contentStyle == "style19" || this.properties.contentStyle == "style26")
    {
    ...
    if (this.properties.contentStyle == "style19" || this.properties.contentStyle == "style26")
    {
        // Create div for text 5
        this._text5 = document.createElement('div');
            this._dialogContent.appendChild(this._text5);
    }


    // Only Style19 needs more than 5 text areas
    ...
    switch(this.properties.contentStyle)
    {
        ...
        case "style23":
            ...
            break;
        case "style24": 
            this._dialogContent.className = "Dialog3Ctrl_Style24";
            this._text1.className = "Dialog3Ctrl_Style24_Text1";
            this._text2.className = "Dialog3Ctrl_Style24_Text2";
            break;
        case "style25":
            this._dialogContent.className = "Dialog3Ctrl_Style25";
            this._text1.className = "Dialog3Ctrl_Style25_Text1";
            this._text2.className = "Dialog3Ctrl_Style25_Text2";
            break;
        case "style26":
            this._dialogContent.className = "Dialog3Ctrl_Style26";
            this._text1.className = "Dialog3Ctrl_Style26_Text1";
            this._text2.className = "Dialog3Ctrl_Style26_Text2";
            this._text3.className = "Dialog3Ctrl_Style26_Text3";
            this._text4.className = "Dialog3Ctrl_Style26_Text4";
            this._text5.className = "Dialog3Ctrl_Style26_Text5";
            break;
        default:
            break;
    }
...
Dialog3Ctrl.prototype._validateTextNum = function(num)
{
    ...
    switch (currStyle)
    {
        ...
        case "style19": // This style supports text 1 - 10
            ...
            break;
        case "style26": // This style supports text 1 - 5
            if (num <= 5)
            {
                valid = true;
            }
