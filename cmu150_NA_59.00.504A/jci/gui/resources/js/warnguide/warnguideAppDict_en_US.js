var Localization_warnguideAppDict_en_US = {
	...
	"ElectricParkingBrakeHighLong" : "A malfunction has occurred in the parking brake system. Consult your Mazda Dealer for inspection.",
	"ElectricParkingBrakeLong" : "A malfunction has occurred in the parking brake system. Consult your Mazda Dealer for inspection.",
	...
	"FWDSysErrorLong" : "4WD System Malfunction or Tire Size is different between the Front and Rear Tires. Have the vehicle checked by a dealer.",
	...
	"HBCLDWSSysErrorLong" : "High Beam Control (HBC)* and/or Lane Departure Warning System (LDWS)* Malfunction. Have the vehicle checked by a dealer if this Indicator stays On.\n*Existence of these features depends on models/trim levels.",
	...
	"HBCLDWSWindshieldFogLong" : "High Beam Control (HBC)* and/or Lane Departure Warning System (LDWS)* Malfunction. Defrost the Windshield.  Have the vehicle checked by a dealer if this Indicator stays On.\n*Existence of these features depends on models/trim levels.",
	...
	"HBCLLDWSCamDisconnectLong" : "High Beam Control (HBC)* and/or Lane Departure Warning System (LDWS)* Malfunction. Clean the Windshield.  Have the vehicle checked by a dealer if this Indicator stays On.\n*Existence of these features depends on models/trim levels.",
	...
	"HighEngineOillevel" : "Engine Oil Level High",
	...
	"LowEngineOillevel" : "Engine Oil Level Low",
	...
	"LowTireAirPressureFlatLong" : "If the tire pressure drops dramatically after the TPMS warning light has illuminated, or if the tire is punctured, the flat tire warning light will also be illuminated. If a run-flat tire is punctured, carefully drive the vehicle to the nearest Mazda Dealer and have the tire changed.",
	...
	"OilLevelSystemMalfunctioning" : "Engine Oil Level Sensor Malfunction",
	"OilLevelSystemMalfunctioningDetail" : "There is a malfunction in the engine oil level sensor. Please have the vehicle checked by a Mazda dealer. ",
