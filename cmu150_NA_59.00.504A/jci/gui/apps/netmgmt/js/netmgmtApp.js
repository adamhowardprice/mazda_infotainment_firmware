...
netmgmtApp.prototype.appInit = function()
{
    ...
    var dataList_NetworkOptions = {
        ...
        itemCount : 3,
        items: [
            { itemStyle : 'styleOnOff', appData : 'wifiSwitch', text1Id : 'WiFi', value : 2, hasCaret : false, disabled : true },
...
netmgmtApp.prototype._getSignalStrengthImage = function(signal)
{
    ...
    if (signal == 0) {
        imageSrc = "./common/images/icons/IcnListWifi_00.png";
    }
    else if (signal <= 25)
    {
        imageSrc = "./common/images/icons/IcnListWifi_01.png";
    }
    else if (signal <= 50)
    {
        imageSrc = "./common/images/icons/IcnListWifi_02.png";
    }
    else if (signal <= 75)
    {
        imageSrc = "./common/images/icons/IcnListWifi_03.png";
    }
    else if (signal <= 100)
    {
        imageSrc = "./common/images/icons/IcnListWifi_04.png";
    }
    else
    {
