...
contactsApp.prototype.appInit = function()
{
    ...
    // cache
    this._importProgressBarStatusStep = 0.5/64;
        ...
        if ( this._deviceConnStatus === "DISCONNECTED")
       {
        ...
        {            
            ...
            case "ExtractionStarted":
                this._importInProgress = true;
                this._importProgressBarStatus=0.10;
                if (this._currentContext && this._currentContextTemplate && this._currentContext.ctxtId === "EditContacts")
                {
                    this._populateEditContactsList();
                }
            ...
            case "Parsing":
                this._importInProgress = true;
                this._importProgressBarStatus=0.20;
                if (this._currentContext && this._currentContextTemplate && this._currentContext.ctxtId === "EditContacts")
                {
                    this._populateEditContactsList();
                }
            ...
            case "Sorting":
                this._importInProgress = true;
                this._importProgressBarStatus=0.70;
                if (this._currentContext && this._currentContextTemplate && this._currentContext.ctxtId === "EditContacts")
                {
                    this._populateEditContactsList();
                }
            ...
            case "Photos":
                this._importInProgress = true;
                this._importProgressBarStatus=this._importProgressBarStatus + this._importProgressBarStatusStep;
                if (this._currentContext && this._currentContextTemplate && this._currentContext.ctxtId === "EditContacts")
                {
                    this._populateEditContactsList();
                }
				...
				itemCount : 3
					...
					if(vehicleAtSpeed)
                    {
                        listItems = [
										...
										{ appData : "style28", text1Id : "", disabled : vehicleAtSpeed, itemStyle :"style28", hasCaret:false, min : 0, max : 1, increment : this._importProgressBarStatusStep, value : this._importProgressBarStatus,  allowAdjust : false },
...
contactsApp.prototype._populateContactDetails = function()
{
    ...
    {
        items[i] = { appData : {eventName : "SelectPhoneNumber", phoneNumber : this.mobileNumber[i]}, text1 : this.mobileNumber[i].replace(/P/g, ","), label1Id : 'MobilePhnNumber', itemStyle : "style14",hasCaret:false, itemBehavior :"shortAndLong"};
    }
    for(k = 0; k < homeNumCount; k++)
    {
        items[i++] = { appData : {eventName : "SelectPhoneNumber", phoneNumber : this.homeNumber[k]}, text1 : this.homeNumber[k].replace(/P/g, ","), label1Id : 'HomePhnNumber' ,itemStyle : "style14",hasCaret:false, itemBehavior :"shortAndLong"};
    }
    for(l = 0; l < workNumCount; l++)
    {
        items[i++] = { appData : {eventName : "SelectPhoneNumber", phoneNumber : this.workNumber[l]}, text1 : this.workNumber[l].replace(/P/g, ","), label1Id : 'WorkPhnNumber' ,itemStyle : "style14",hasCaret:false, itemBehavior :"shortAndLong"};
    }
    for(n = 0; n < otherNumCount; n++)
    {
        items[i++] = { appData : {eventName : "SelectPhoneNumber", phoneNumber : this.otherNumber[n]}, text1 : this.otherNumber[n].replace(/P/g, ","), label1Id : 'OtherPhnNumber',itemStyle : "style14",hasCaret:false, itemBehavior :"shortAndLong"};
    }   
    if(addressCount)
    {
		this.address.street  = this.address.street.replace(/\r\n/g," ");
		this.address.city    = this.address.city.replace(/\r\n/g," ");
		this.address.region  = this.address.region.replace(/\r\n/g," ");
		this.address.country = this.address.country.replace(/\r\n/g," ");
		this.address.zipcode = this.address.zipcode.replace(/\r\n/g," ");
