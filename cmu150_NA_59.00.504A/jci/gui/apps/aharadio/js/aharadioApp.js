...
aharadioApp.prototype._SetContentDetailsMsgHandler = function (msg)
{
    ...
    {
    	// TODO: detail1
		if(msg.params.payload.detail1 && msg.params.payload.detail1 !== " " && this._cacheStationData.contentTitle == " ")
		{
			log.info("For NowPlaying setting ContentTitle to "+msg.params.payload.detail1);
			this._cacheStationData.contentTitle = msg.params.payload.detail1;
		}
    ...
    {
    	// TODO: detail1
		if(msg.params.payload.detail1 && msg.params.payload.detail1 !== " " && this._cacheLBSDetails.contentTitle == " ")
		{
			log.info("For LBSDetails setting ContentTitle to "+msg.params.payload.detail1);
			this._cacheLBSDetails.contentTitle = msg.params.payload.detail1;
		}
