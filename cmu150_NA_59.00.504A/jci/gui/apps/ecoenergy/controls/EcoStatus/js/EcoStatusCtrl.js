...
EcoStatusCtrl.prototype._createStructure = function()
{
	...
	else if(this.properties.vehicleType==="SETTINGS_VehicleModelType_J78A")
	{
		for(var step = 1; step <= 5 ; step++)
		{
			var el = document.createElement('div');
			el.id = 'EcoStatusChargeLvl'+step;
			el.className = 'EcoStatusCtrl_J78A_anim'+step;
			this.iEloopContainer.appendChild(el);
		}
		...
		for(var stepRt = 1; stepRt <= 5 ; stepRt++)
		{
			var ele = document.createElement('div');
			ele.id = 'EcoStatusChargeRightLvl'+stepRt;
			ele.className = 'EcoStatusCtrl_J78A_animRight'+stepRt;
			this.iEloopContainer.appendChild(ele);
		}
		...
		for(var stepTop = 1; stepTop <= 5 ; stepTop++)
		{
			...
			elem.className = 'EcoStatusCtrl_J78A_animTop'+stepTop;
    ...
    {           
        ...
        this.iEloopBatteryToCarDischargeLeft.className = 'EcoStatusCtrl_iEloop_BatteryToCarDischargeLeft_J78A';  
        ...
        this.iEloopBatteryToCarDischargeRight.className = 'EcoStatusCtrl_iEloop_BatteryToCarDischargeRight_J78A';    
	...
	/* As part of SW00167439 
	if(this.properties.vehicleType==="SETTINGS_VehicleModelType_J78A")
	{
		this.fuelEfficiencyContainer.style.top='-6px';
		this.fuelSinceReset.style.top='42px';
	}	 */	
...
EcoStatusCtrl.prototype._capChgLvlTimerCallback = function()
{
    ...
    if (this.properties.iEloopData.capChgLvl != null)
    {
        ...
        if (this._currentCapChgLvl > 0)
        {
			...
			{
				this.iEloopBattery.className = "EcoStatusCtrl_iEloop_Battery_J78A_0"+ this._currentCapChgLvl;
			}
			else
			{
        ...
        else
        {
			...
			{
				this.iEloopBattery.className = "EcoStatusCtrl_iEloop_Battery_Off_J78A";
			}
			else
			{
        ...
        if (this.properties.ctrlStyle != "iStopOnly")
        {
            if(this.properties.iEloopData.dataKnown)
            {
                ...
                if (delta > 0)
                {
					...
					{
						this.iEloopAlternator.className = "EcoStatusCtrl_iEloop_Alternator_On_J78A";
					}
					else
					{
					...
					{
						this.iEloopFrontWheelsGlow.className        = "EcoStatusCtrl_iEloop_FrontWheelsGlow_J78A";
						this.iEloopBatteryGlow.className            = "EcoStatusCtrl_iEloop_Battery_Glow_J78A";
						this.iEloopChargeShaft.className            = "EcoStatusCtrl_iEloop_ChargeShaft_J78A";
					}
					else
					{
                ...
                else if (delta == 0 && this.properties.iEloopData.electLdUsgLvl == "YES")
                {
					...
					//J78A
					else if(this.vehicleType == "SETTINGS_VehicleModelType_J78A")
					{
						this.iEloopCarGlow.className            = "EcoStatusCtrl_iEloop_CarGlow_J78A";
					}
					
					else if((this.vehicleType == "SETTINGS_VehicleModelType_J03K") ||(this.vehicleType=="SETTINGS_VehicleModelType_J53") || (this.vehicleType=="SETTINGS_VehicleModelType_J72A"))
					{
						this.iEloopCarGlow.className            = "EcoStatusCtrl_iEloop_CarGlow_J03K";
					}
					else if((this.vehicleType == "SETTINGS_VehicleModelType_J71") ||(this.vehicleType=="SETTINGS_VehicleModelType_J36")||(this.vehicleType=="SETTINGS_VehicleModelType_J36IPM"))
					{
					...
					{
						this.iEloopAlternator.className             = "EcoStatusCtrl_iEloop_Alternator_Off_J78A";
					}
					else
					{
...
EcoStatusCtrl.prototype.setdiv = function(value)
{
	...
	else if((this.vehicleType=="SETTINGS_VehicleModelType_J36") ||(this.vehicleType=="SETTINGS_VehicleModelType_J71")||(this.vehicleType=="SETTINGS_VehicleModelType_J36IPM"))
	{
	...
	{
		this.iEloopCarBottomLayer.className=this.iEloopCarBottomLayer.className+"_J78A";
		this.iEloopCarTopLayer.className=this.iEloopCarTopLayer.className+"_J78A";
		this.iEloopBatteryToCarDischargeLeft.className = "EcoStatusCtrl_iEloop_BatteryToCarDischargeLeft_J78A";
		this.iEloopBatteryToCarDischargeRight.className = "EcoStatusCtrl_iEloop_BatteryToCarDischargeRight_J78A";
	}
