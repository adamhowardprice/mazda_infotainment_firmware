...
backupparkingApp.prototype.appInit = function()
{
    ...
    this._contextTable = {
       ...
       "Calibration" : {
            ...
            "controlProperties": {
                "ScreenSettings2Ctrl" : {
                    adjustButtonConfig : {"enabled": false, visible:false, "adjustLabelId": "", "closeLabelId": "", "selectCallback": this._adjustBtnHandler.bind(this)},
                    backButtonConfig : {"enabled": true, appData: "SelectExitCalibration","selectCallback": this._backBtnHandler.bind(this)},
                    tabsButtonConfig : {"visible": false, "currentlySelectedTab": 0, "tabsConfig": this._tabsConfig},
                } // end of properties for "ScreenSettings2Ctrl" 
            },
            "readyFunction" : this._CalibrationReadyToDisplay.bind(this),
            "displayedFunction": this._CalibrationCtxtTmpltDisplayed.bind(this)
        }, // end of "BackupCameraDisplay"
       ...
       // ParkingSensorDisplay 
        ...
        // TVMCameraDisplay - Included CI 3339
        "TVMCameraDisplay" : {
            "hideHomeBtn" : true,
            "template" : "ScreenSettings2Tmplt",
            "properties": {
            ...
            "controlProperties": {
                "ScreenSettings2Ctrl" : {
                    style : "none",
                    adjustButtonConfig : {"enabled": true, "adjustLabelId": "", "closeLabelId": "", "selectCallback": this._adjustBtnHandler.bind(this)},
                    cvcButtonConfig : {"enabled": true, appData: "SelectCVC","selectCallback": this._cvcBtnHandler.bind(this)},
                    tabsButtonConfig : {"visible": false, "currentlySelectedTab": 0, "tabsConfig": this._tabsConfig},
                    secondaryButtonConfig : null,   //These parameters are null (or omitted)
                    secondaryButtonCallback : null, //to not include a secondary button in this context
                    slideCallback : this._slideHandler.bind(this), // called when an item is dragged
           ...
           "contextInFunction" : this._TVMCameraDisplayContextIn.bind(this),
           "readyFunction" : this._BackupCameraDisplayReadyToDisplay.bind(this),
           "displayedFunction": this._BackupCameraDisplayCtxtTmpltDisplayed.bind(this)
        }, // end of "TVMCameraDisplay"
        ...
        "TVMCameraInhibit" : {
            ...
            "contextInFunction" : this._TVMCameraInhibitContextIn.bind(this),
            "readyFunction" : this._BackupCameraDisplayReadyToDisplay.bind(this),
            "displayedFunction": this._BackupCameraDisplayCtxtTmpltDisplayed.bind(this)
        }, // end of "TVMCameraInhibit"

	       
        // TVMNoVideoSignalNotification _ Updated for CI 3339
        "TVMNoVideoSignalNotification" : {
            "hideHomeBtn" : true,
            "template" : "ScreenSettings2Tmplt",
            "properties": {
                "keybrdInputSurface" : "JCI_OPERA_PRIMARY", 
            ...
            "controlProperties": {
                "ScreenSettings2Ctrl" : {
                    style : "none",
                    adjustButtonConfig : {"enabled": false, "adjustLabelId": "", "closeLabelId": "", "selectCallback": this._adjustBtnHandler.bind(this)},
                    cvcButtonConfig : {"enabled": false, appData: "SelectCVC","selectCallback": this._cvcBtnHandler.bind(this)},
                    tabsButtonConfig : {"visible": false, "currentlySelectedTab": 0, "tabsConfig": this._tabsConfig},
                    secondaryButtonConfig : null, //These parameters are null (or omitted)
            ...
            "contextInFunction" : this._TVMNoVideoSignalNotificationContextIn.bind(this),
            "displayedFunction": this._NoVideoSignalNotificationCtxtTmpltDisplayed.bind(this)
        }, // end of TVMNoVideoSignalNotification

         // TVMNoVideoSignalInhibit 
        "TVMNoVideoSignalInhibit" : {
            "hideHomeBtn" : true,
            "template" : "ScreenSettings2Tmplt",
            "properties": {
            ...
            "contextInFunction" : this._TVMNoVideoSignalInhibitContextIn.bind(this),
            "displayedFunction": this._NoVideoSignalNotificationCtxtTmpltDisplayed.bind(this)
        }, // end of TVMNoVideoSignalInhibit
        ...
        "TVMVideoSettings" : {
            ...
            "readyFunction" : this._VideoSettingsCtxtTmpltReadyToDisplay.bind(this),
        }, // end of "TVMVideoSettings"


        // TVMVideoSettingsInhibit
        "TVMVideoSettingsInhibit" : {
            "hideHomeBtn" : true,
            "template" : "ScreenSettings2Tmplt",
            "properties": {
...
// TVMCameraDisplay ctxt
 backupparkingApp.prototype._TVMCameraDisplayContextIn = function()
{
    var steeringWheelType = framework.getSharedData("vehsettings","SteeringWheelLoc");
    log.info("Inside TVMCameraDisplayContextIn, wheelType ="+steeringWheelType);
    if( steeringWheelType === "LHD" || steeringWheelType ==="RHD")
	{
        this._contextTable["TVMCameraDisplay"].controlProperties.ScreenSettings2Ctrl.style = "bottom_"+steeringWheelType;
    }
}

// TVMCameraInhibit ctxt
backupparkingApp.prototype._TVMCameraInhibitContextIn = function()
{
    var steeringWheelType = framework.getSharedData("vehsettings","SteeringWheelLoc");
    log.info("Inside TVMCameraInhibitContextIn, wheelType ="+steeringWheelType);
    if( steeringWheelType === "LHD" || steeringWheelType ==="RHD")
	{
        this._contextTable["TVMCameraInhibit"].controlProperties.ScreenSettings2Ctrl.style = "bottom_"+steeringWheelType;
    }
}


// TVMNoVideoSignalNotification ctxt
backupparkingApp.prototype._TVMNoVideoSignalNotificationContextIn = function()
{
    var steeringWheelType = framework.getSharedData("vehsettings","SteeringWheelLoc");
    log.info("Inside TVMNoVideoSignalNotificationContextIn, wheelType = "+steeringWheelType);
    if( steeringWheelType === "LHD" || steeringWheelType ==="RHD")
	{
        this._contextTable["TVMNoVideoSignalNotification"].controlProperties.ScreenSettings2Ctrl.style = "bottom_"+steeringWheelType;
    }   
}

//TVMNoVideoSignalInhibit ctxt
backupparkingApp.prototype._TVMNoVideoSignalInhibitContextIn = function()
{
    var steeringWheelType = framework.getSharedData("vehsettings","SteeringWheelLoc");
    log.info("Inside TVMNoVideoSignalInhibitContextIn, wheelType = "+steeringWheelType);
    if( steeringWheelType === "LHD" || steeringWheelType ==="RHD")
	{
        this._contextTable["TVMNoVideoSignalInhibit"].controlProperties.ScreenSettings2Ctrl.style = "bottom_"+steeringWheelType;
    }
}
...
backupparkingApp.prototype._BackupCameraDisplayReadyToDisplay = function()
{
    if (this._currentContext && this._currentContextTemplate && 
        (this._currentContext.ctxtId == "BackupCameraDisplay" || this._currentContext.ctxtId == "TVMCameraDisplay" || this._currentContext.ctxtId == "TVMCameraInhibit"))
    {
...
//Calibration ctxt
backupparkingApp.prototype._CalibrationReadyToDisplay = function()
{
    if (this._currentContext && this._currentContextTemplate && this._currentContext.ctxtId == "Calibration")
    {
        this._cachedSpeed = framework.common.getAtSpeedValue();
...
// Send an event to MMUI to notify that Adjust button is now available in displayed function
backupparkingApp.prototype._CalibrationCtxtTmpltDisplayed = function()
{
    // Send an event to MMUI to notify that Adjust button is enabled now
    framework.sendEventToMmui(this.uiaId, "AdjustAvailable", {"payload": {"adjustButtonStatus": 1}});
}
...
backupparkingApp.prototype._VideoSettingsCtxtTmpltReadyToDisplay = function()
{
    ...
    if(this._currentContext && this._currentContext.ctxtId && 
        (this._currentContext.ctxtId === "VideoSettings" || this._currentContext.ctxtId === "TVMVideoSettings" || this._currentContext.ctxtId === "TVMVideoSettingsInhibit"))
    {
    ...
    if (msg)
    {
        ...
        if (this._currentContext && this._currentContextTemplate && this._currentContext.ctxtId)
        {
            switch(this._currentContext.ctxtId)
            {
                ...
                case "TVMCameraDisplay" :
                case "TVMCameraInhibit" :
                case "BUCAndPSMDisplay" :
                case "VideoSettings" : 
                case "TVMVideoSettings" :
                case "TVMVideoSettingsInhibit" :   
 ...
 */
backupparkingApp.prototype._backBtnHandler = function(ctrlObj, appData, params)
{
    if(params.backBtn == "backBtn")
    {
        framework.sendEventToMmui(this.uiaId, appData);
    }
};
...
/*
 * Callback for the cvc button - CI 3339
 */
backupparkingApp.prototype._cvcBtnHandler = function(ctrlObj, appData, params)
{
    if(params.cvcBtn == "cvcBtn")
    {
        framework.sendEventToMmui(this.uiaId, appData);
    }
};
