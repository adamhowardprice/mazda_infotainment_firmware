/*
 ...
 v.0.14(08-Apr-2015) - (SC0325) GUI J78A Warning Guidance
 */
...
warnguideApp.prototype._warningListReadyToDisplay = function()
{
    ...
    if(this._currentContextTemplate)
    {
        ...
        if ( this._warningCount > 0)//Checks whether any warnings are present or not, if present then cache it.
        {
			...
			{				
					this._warningsDataBase[46].imagePathEnable = "apps/warnguide/images/IcnWrn_AT_En.png",
					this._warningsDataBase[46].imagePathDisable = "apps/warnguide/images/IcnWrn_AT_Ds.png";		
					this._warningsDataBase[46].warning_Name = "AutoTransSysErrorShrt";
					this._warningsDataBase[46].detailed_Description = "AutoTransSysErrorLong";
			}
			else if((this._cachedVehicleType == "SETTINGS_VehicleModelType_J36") /*&& (this._cachedVehicleType !== "SETTINGS_VehicleModelType_J12A")*/ )
			{
			...
			else if(this._FSCType == 2 || this._FSCType == 3 || this._FSCType == 5 || this._FSCType == 8 || this._FSCType == 9 || this._FSCType == 12)
			{
				this._warningsDataBase[68].warning_no = 69;
			...
			else if(this._FSCType == 2 || this._FSCType == 5 || this._FSCType == 9)
			{
				// Warning number 72 according to UI spec
				this._warningsDataBase[69].warning_no = 70;
			...
			if(this._FSCType == 2 || this._FSCType == 4 || this._FSCType == 5 || this._FSCType == 7 || this._FSCType == 9 || this._FSCType == 10) // SC0428 changes
			{
				// Warning number 93 according to UI spec
				this._warningsDataBase[95].warning_no = 96;
				this._warningsDataBase[95].warning_Name = "LDWSLASUnavailableShrt_1";
				this._warningsDataBase[95].detailed_Description = "LDWSLASUnavailableLong_1";
				this._warningsDataBase[95].imagePathEnable = "apps/warnguide/images/IcnWrn70_En.png";
				this._warningsDataBase[95].imagePathDisable = "apps/warnguide/images/IcnWrn70_Ds.png";
				
			}	
			else if(this._FSCType == 11 || this._FSCType == 12) // SC0428 changes
			{
				// Warning number 93 according to UI spec
				this._warningsDataBase[95].warning_no = 96;
				this._warningsDataBase[95].warning_Name = "LDWSLASUnavailableShrt_2";
				this._warningsDataBase[95].detailed_Description = "LDWSLASUnavailableLong_2";
				this._warningsDataBase[95].imagePathEnable = "apps/warnguide/images/IcnWrn70_En.png";
				this._warningsDataBase[95].imagePathDisable = "apps/warnguide/images/IcnWrn70_Ds.png";
				
			}	
			if(this._FSCType == 2 || this._FSCType == 3 || this._FSCType == 5 || this._FSCType == 8 || this._FSCType == 9 || this._FSCType == 12) // SC0428 changes
			{
				// Warning number 94 according to UI spec
				this._warningsDataBase[96].warning_no = 97;
				this._warningsDataBase[96].warning_Name = "HBCALHUnavailableShrt_1";
				this._warningsDataBase[96].detailed_Description = "HBCALHUnavailableLong_1";
				this._warningsDataBase[96].imagePathEnable = "apps/warnguide/images/IcnWrn71_En.png";
				this._warningsDataBase[96].imagePathDisable = "apps/warnguide/images/IcnWrn71_Ds.png";
				
			}	
			else if(this._FSCType == 10 || this._FSCType == 11) // SC0428 changes
			{
				// Warning number 94 according to UI spec
				this._warningsDataBase[96].warning_no = 97;
				this._warningsDataBase[96].warning_Name = "HBCALHUnavailableShrt_2";
				this._warningsDataBase[96].detailed_Description = "HBCALHUnavailableLong_2";
				this._warningsDataBase[96].imagePathEnable = "apps/warnguide/images/IcnWrn71_En.png";
				this._warningsDataBase[96].imagePathDisable = "apps/warnguide/images/IcnWrn71_Ds.png";
...
warnguideApp.prototype._createWarningDatabase = function() 
{
    ...
    this._warningsDataBase[0] = {
        ...
        this._warningsDataBase[37] = {
            ...
            "imagePathEnable" : "apps/warnguide/images/IcnWrn37_J03_En.png",
            "imagePathDisable" :"apps/warnguide/images/IcnWrn37_J03_Ds.png"
        };
        this._warningsDataBase[38] = {
           ...
           this._warningsDataBase[39] = {
            ...
            "warning_Priority" : "Low",
            "warning_Name" : "AutoLevelSystemErrorShrtJ03",
            "detailed_Description" : "HeadlightSystemErrorLongJ03",
            "imagePathEnable" : "apps/warnguide/images/IcnWrn40_J03_En.png",
            "imagePathDisable" :"apps/warnguide/images/IcnWrn40_J03_Ds.png"
        };
		...
		this._warningsDataBase[88] = { /*J78A Changes New Warnings added*/
			"warning_no" : 89,
			"warning_Id" : "LowEngineOillevel",
			"warning_Priority" : "Low",
			"warning_Name" : "LowEngineOillevel", 	
			"detailed_Description" : "LowEngineOillevelDetail",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn91_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn91_Ds.png"
        };
		
		this._warningsDataBase[89] = { /*J78A Changes New Warnings added*/
			"warning_no" : 90,
			"warning_Id" : "HighEngineOillevel",
			"warning_Priority" : "Low",
			"warning_Name" : "HighEngineOillevel", 	
			"detailed_Description" : "HighEngineOillevelDetail",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn75_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn75_Ds.png", 
        };
		
		this._warningsDataBase[90] = { /*J78A Changes New Warnings added*/
			"warning_no" : 91,
			"warning_Id" : "OilLevelSystemMalfunctioning",
			"warning_Priority" : "Low",
			"warning_Name" : "OilLevelSystemMalfunctioning", 	
			"detailed_Description" : "OilLevelSystemMalfunctioningDetail",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn19_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn19_Ds.png", 
        };        
        
			this._warningsDataBase[91] = { /*J12F Changes New Warnings added*/
			"warning_no" : 92,
			"warning_Id" : "Run_Cooling_Pump",
			"warning_Priority" : "Low",
			"warning_Name" : "AfterRunCoolingPumpShrt", 	
			"detailed_Description" : "AfterRunCoolingPumpLong",
			"imagePathEnable" : "apps/warnguide/images/IcnWrnOilLevelSysMalfunction_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrnOilLevelSysMalfunction_Ds.png", 
        };
        
			this._warningsDataBase[92] = { /*J12F Changes New Warnings added*/
			"warning_no" : 93,
			"warning_Id" : "Cold_Start_Disable",
			"warning_Priority" : "Low",
			"warning_Name" : "ColdStartDisableShrt", 	
			"detailed_Description" : "ColdStartDisableLong",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn83_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn83_Ds.png", 
        };        
        
			this._warningsDataBase[93] = { /*J12F Changes New Warnings added*/
			"warning_no" : 94,
			"warning_Id" : "Electronic_Throttle_Control",
			"warning_Priority" : "Low",
			"warning_Name" : "ElectronicThrottleControlShrt", 	
			"detailed_Description" : "ElectronicThrottleControlLong",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn_ETC_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn_ETC_Ds.png", 
        };
        
        this._warningsDataBase[94] = { /*SC0428 Changes New Warnings added*/
			"warning_no" : 95,
			"warning_Id" : "SCBSUnavailable",
			"warning_Priority" : "Low",
			"warning_Name" : "SCBSUnavailableShrt1", 	
			"detailed_Description" : "SCBSUnavailableLong1",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn53_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn53_Ds.png", 
        };
        
        this._warningsDataBase[95] = { /*SC0428 Changes New Warnings added*/
			"warning_no" : 96,
			"warning_Id" : "LDWSLASUnavailable",
			"warning_Priority" : "Low",
			"warning_Name" : "LDWSLASUnavailableShrt_1", 	
			"detailed_Description" : "LDWSLASUnavailableLong_1",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn70_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn70_Ds.png", 
        };
        
        this._warningsDataBase[96] = { /*SC0428 Changes New Warnings added*/
			"warning_no" : 97,
			"warning_Id" : "HBCALHUnavailable",
			"warning_Priority" : "Low",
			"warning_Name" : "HBCALHUnavailableShrt_1", 	
			"detailed_Description" : "HBCALHUnavailableLong_1",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn71_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn71_Ds.png", 
        };
        
        this._warningsDataBase[97] = { /*CI-3839 Changes New Warnings added*/
			"warning_no" : 98,
			"warning_Id" : "SCRMalfunction",
			"warning_Priority" : "Low",
			"warning_Name" : "ScrMalfunction", 	
			"detailed_Description" : "SCRMalfunction100Long",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn98_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn98_Ds.png", 
        };
        
        this._warningsDataBase[98] = { /*CI-3839 Changes New Warnings added*/
			"warning_no" : 99,
			"warning_Id" : "SCRMalfunction1",
			"warning_Priority" : "Low",
			"warning_Name" : "ScrMalfunction", 	
			"detailed_Description" : "SCRMalfunction101Long",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn98_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn98_Ds.png", 
        };
        
        this._warningsDataBase[99] = { /*CI-3839 Changes New Warnings added*/
			"warning_no" : 100,
			"warning_Id" : "SCRMalfunction2",
			"warning_Priority" : "Low",
			"warning_Name" : "ScrMalfunction", 	
			"detailed_Description" : "SCRMalfunction102Long",
			"imagePathEnable" : "apps/warnguide/images/IcnWrn98_En.png", 
			"imagePathDisable" :"apps/warnguide/images/IcnWrn98_Ds.png", 
        };

        this._warningsDataBase[100] = { /*CI-4273 Changes New Warnings added*/
            "warning_no" : 101,
            "warning_Id" : "SCBSMalfunction1",
            "warning_Priority" : "Low",
            "warning_Name" : "SCBSSysErrorShrt",
            "detailed_Description" : "SCBSSysErrorLong",
            "imagePathEnable" : "apps/warnguide/images/IcnWrn53_En.png",
        ...
        this._warningsDataBase[101] = { /*CI-4273 Changes New Warnings added*/
            "warning_no" : 102,
            "warning_Id" : "SCBSMalfunction2",
            "warning_Priority" : "Low",
            "warning_Name" : "SCBSWindshieldSoilingShrt",
            "detailed_Description" : "SCBSWindshieldSoilingLong",
            "imagePathEnable" : "apps/warnguide/images/IcnWrn53_En.png",
        ...
        this._warningsDataBase[102] = { /*CI-4273 Changes New Warnings added*/
            "warning_no" : 103,
            "warning_Id" : "SCBSMalfunction3",
            "warning_Priority" : "Low",
            "warning_Name" : "SCBSSysErrorShort_105",
            "detailed_Description" : "SCBSSysErrorLong_105",
            "imagePathEnable" : "apps/warnguide/images/IcnWrn53_En.png",
            "imagePathDisable" :"apps/warnguide/images/IcnWrn53_Ds.png",
        };
};
