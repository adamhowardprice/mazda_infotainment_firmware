var Localization_warnguideAppDict_en_US = {
    ...
    "Dummy1Shrt" : "Dummy Warning",
    "Dummy1Detail" : "You can relax",
    "SCBSUnavailableShrt1" : "SCBS Unavailable",
    "SCBSUnavailableLong1" : "Smart City Brake Support (SCBS) Unavailable",
    "LDWSLASUnavailableShrt_1" : "LDWS unavailable",
    "LDWSLASUnavailableLong_1" : "Lane Departure Warning System (LDWS) Unavailable",
    "LDWSLASUnavailableShrt_2" : "LAS Unavailable",
    "LDWSLASUnavailableLong_2" : "Lane-Keep Assist System (LAS) Unavailable",
    "HBCALHUnavailableShrt_1" : "HBC unavailable",
    "HBCALHUnavailableLong_1" : "High Beam Control (HBC) Unavailable",
    "HBCALHUnavailableShrt_2" : "ALH Unavailable",
    "HBCALHUnavailableLong_2" : "Adaptive LED Headlights (ALH) Unavailable",
    "DEFLowLevelShrt" : "DEF level is low",
    "DEFLowLevelLong" : "Refill Diesel Exhaust Fluid (DEF).DEF level is low.See owner's manual.",
    "DEFVeryLowLevelShrt" : "DEF level is very low",
    "DEFVeryLowLevelLong" : "Refill Diesel Exhaust Fluid (DEF).DEF level is low.Engine start will be not available.See owner's manual.",
    "DEFEmptyShrt" : "DEF is empty",
    "DEFEmptyLong" : "Refill Diesel Exhaust Fluid (DEF).DEF is empty.Engine start is not available.See owner's manual.",
    "SCRMalfunction_1Shrt" : "SCR malfunction",
    "SCRMalfunction_1Long" : "Emissions System (SCR) Malfunction.Engine start will be blocked.See owner's manual.",
    "SCRMalfunction_2Shrt" : "SCR malfunction",
    "SCRMalfunction_2Long" : "Emissions System (SCR) Malfunction.Engine start is not available.See owner's manual.",
};
