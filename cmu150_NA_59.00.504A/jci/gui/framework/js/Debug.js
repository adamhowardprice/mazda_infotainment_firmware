...
function Debug()
{
    ...
    this.__defineSetter__('debugPanelEnabled', function(flag)
    {
        ...
        {
            //display html divs
            log.debug("Adding Debug Panel to DOM.");
...
Debug.prototype._evtToMmuiCallbacks = function(uiaId, eventId, params)
{
    ...
    if (uiaId == "Common")
    {
        ...
        if (!uiaId)
        {
            log.debug("Debug cannot retrieve current app instance.");
        }
    ...
    {
        log.debug("No Entry found for Global.GoLeft event in current context: " + framework.getCurrentApp() + " "  + framework._currentContext);
    }
}
